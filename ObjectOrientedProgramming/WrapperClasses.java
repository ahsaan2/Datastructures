...
public class WrapperClasses {
    ...
    //-->>Garbage Collection in java-->><>Java does allow tp destroy objects manually
    // so we tell java to do these things when ever you decide to destroy object--> that is done by finalize 
    // Finalize--> it is called by the garbage collector just before the object is garbage collectedd
    // this method is used to perform any necessary clean up before the object is destroyed
